...
Lo \emph{inter alia}. \cite{lo2002,mertens2002comments,Ledoit2008850,Leung2008,Wright2012} 
...
\begin{equation}
\label{eqn:pvvar_def}
\pvvar = \twobytwossym{\pvmom[2] - \pvmu^2}{\pvmom[3] - \mu\pvmom[2]}{\pvmom[4] - \pvmom[2]^2},
\end{equation}
where \pvmom[i] is the uncentered \kth{i} moment of \reti. After much
...
Now let $g$ be some vector valued function of the vector \pvsnr.
Applying the Delta method,
\begin{equation}
\sqrt{\ssiz}\wrapParens{\funcit{g}{\svsr} - \funcit{g}{\pvsnr}} 
\rightsquigarrow 
\normlaw{0,\qoform{\qoform{\pvvar}{\wrapParens{\dbyd{\pvsnr}{\vcat{\pvmu}{\pvmom[2]}}}}}{\dbyd{g}{\pvsnr}}}.
...
let $g$ be the function which constructs the $\nlatf-1$
contrasts: 
$$
\funcit{g}{\pvsnr} = 
\asvec{\pvsnr[1] - \pvsnr[2],\ldots,\pvsnr[\nlatf-1] - \pvsnr[\nlatf]}.
$$
One is then testing the null hypothesis $H_0: \funcit{g}{\pvsnr} = 0$.
Asymptotically, under the null, 
$$
\ssiz \qform{\minv{\wrapParens{\qoform{\qoform{\svvar}{\wrapParens{\dbyd{\svsr}{\vcat{\svmu}{\svmom[2]}}}}}{\dbyd{g}{\svsr}}}}}{\funcit{g}{\svsr}} \sim \chisqlaw{\nlatf-1}.
$$

There are a number of modifications of this basic method: 
Leung and Wong described the basic method.  \cite{Leung2008}
Wright \etal suggest that the test statistic be approximated by an
\flaw{}-distribution. \cite{Wright2012} 
...
\tstat-approximation:
$$
\frac{\sqrt{\ssiz}\funcit{g}{\svsr}}{\sqrt{\qform{\minv{\wrapParens{\qoform{\qoform{\svvar}{\wrapParens{\dbyd{\svsr}{\vcat{\svmu}{\svmom[2]}}}}}}}{\dbyd{g}{\svsr}}}}}
\sim \tlaw{\ssiz-1}.
$$
%UNFOLD
...
inflated type I rate. (2FIX: is this true? do a study?)
...
All distributions have been rescaled to have $\psnr = 1.0$; that is,
...
tests, against the alternative $H_a: \psnr < 1.0$.
