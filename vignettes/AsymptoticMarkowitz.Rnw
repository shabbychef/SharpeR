...
2FIX:
A typical analysis from MGLH land ... 
\cite{Rencher2002,Muller1984143}
...
Let $\svsm[f] \defeq \oneby{\ssiz}\sum_i \ogram{\aavreti[i+1]}$,
...
%\begin{equation}
\begin{multline}
\sqrt{\ssiz}\wrapParens{\fvech{\minv{\svsm[f]}} -
\fvech{\minv{\pvsm[f]}}} 
\rightsquigarrow \\
\normlaw{0,\qoform{\pvvar}{\wrapBracks{\EXD{\wrapParens{\AkronA{\minv{\pvsm[f]}}}}}}}.
