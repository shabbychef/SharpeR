...
\begin{equation}
\max_{\sportw : \mnull{\hejG} \sportw = 0,\, \qform{\svsig}{\sportw} \le R^2} 
\frac{\trAB{\sportw}{\svmu} - \rfr}{\sqrt{\qform{\svsig}{\sportw}}},
...
$$
c =
\frac{R}{\sqrt{\qform{\minv{\wrapParens{\qoform{\svsig}{\hejG}}}}{\wrapParens{\hejG\svmu}}}}.
$$
The \txtSR of this portfolio is
\begin{equation}
\ssroptG{\hejG} 
...
\wrapParens{\ssroptG{\hejG} + \frac{\rfr}{R}}^2 \sim
...
\begin{equation}
\max_{\sportw : \hejG\svsig \sportw = \hejg,\, \qform{\svsig}{\sportw} \le R^2} 
\frac{\trAB{\sportw}{\svmu} - \rfr}{\sqrt{\qform{\svsig}{\sportw}}},
...
\begin{equation}
	...
	c^2 &= \frac{R^2 - \qform{\wrapParens{\qoform{\svsig}{\hejG}}}{\hejg}}{
