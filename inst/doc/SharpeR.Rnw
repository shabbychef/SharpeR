...
<<'haircutting',fig.cap="Q-Q plot of 1024 simulated haircut values versus the approximation given by \\eqnref{hcut_apx} is shown.">>=
require(MASS)
...
<<'estimate_overfit',fig.cap="Q-Q plot of 1024 achieved optimal \\txtSR values from brute force search over both windows of a Moving Average Crossover under the null of driftless log returns with zero autocorrelation versus the approximation by a 2-parameter optimal \\txtSR distribution is shown.">>=
require(TTR)
