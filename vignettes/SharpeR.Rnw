...
$$
\sportwoptG{\Mtx{G}} 
= c\, \tr{\Mtx{G}} \minv{\wrapParens{\qoform{\svsig}{\Mtx{G}}}} \Mtx{G}\svmu,
$$
where the constant $c$ is chosen to maximize return under the given risk
budget. The \txtSR of this portfolio is
\begin{equation}
\ssroptG{\Mtx{G}} 
 = \frac{\trAB{\sportwoptG{\Mtx{G}}}{\svmu} - \rfr}{\sqrt{\qform{\svsig}{\sportwoptG{\Mtx{G}}}}}
