...
\begin{split}
\pvvar &= 
\twobytwossym{\pvmom[2] - \pvmu^2}{\pvmom[3] - \mu\pvmom[2]}{\pvmom[4] - \pvmom[2]^2},\\
&= \twobytwossym{\pvsigma^2}{\pvsigma^2\wrapParens{\pvsigma\pvcmom[3] +
2\pvmu}}{\pvsigma^4\wrapParens{\pvcmom[4] + 2} + 4 \pvsigma^3 \pvmu\pvcmom[3] +
4 \pvsigma^2\pvmu^2},\\
&= \pvsigma^2 \twobytwossym{1}{\pvsigma\pvcmom[3] +
2\pvmu}{\pvsigma^2\wrapParens{\pvcmom[4] + 2} + 4 \pvsigma \pvmu\pvcmom[3] + 4
\pvmu^2}.
\end{split}
\end{equation}
...
$$
\ssiz
\qform{\minv{\wrapParens{\qoform{\pvvar}{\wrapParens{\dbyd{\vect{g}}{\pvsnr}\dbyd{\pvsnr}{\vcat{\pvmu}{\pvmom[2]}}}}}}}{\funcit{\vect{g}}{\svsr}}
\sim \chisqlaw{\nlatf-1}.
$$
...
Suppose you wish to compare two possible values of the population
...
to the constraints in \eqnref{lrt_null}.
